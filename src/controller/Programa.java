...
public class Programa {
	...
	if (this.frame.getStatusTarefaBuscar().equals(StatusTarefa.FINALIZADAS)) {
	...
	} else if (this.frame.getStatusTarefaBuscar().equals(StatusTarefa.NAO_FINALIZADAS)) {
			querySQL += " AND finalizada = 'N'";
	} else if (this.frame.getStatusTarefaBuscar().equals(StatusTarefa.EM_ANDAMENTO)) {
